...
// Même mécanique/valeurs que la répétition des séances (cf. planning.tsx) —
// dupliqué ici plutôt que partagé, comme les autres petites constantes de ce
// fichier (DISCIPLINE_META etc. viennent d'agenda/meta.ts, mais REPEAT_OPTIONS
// n'a qu'un seul autre appelant, pas encore de raison de le centraliser).
